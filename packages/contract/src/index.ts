// @webhook-co/contract — the transport-agnostic capability registry (§0.9).
//
...
// contract, the closed replay TargetSchema (H6), the RFC 9728 protected-resource-
// metadata / verifyBearer obligations (§0.8), and the parity-conformance machinery.
