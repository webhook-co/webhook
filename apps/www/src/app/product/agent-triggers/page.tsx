    ...
    >
      ...
      >
        <p>
          ...
          with a cursor it acknowledges as it goes. Delivery is at-least-once: the event is durably
          captured the moment it arrives, whether or not your agent is up, and the cursor only
          advances past events you&rsquo;ve acked. You drive the read cadence; we hold the events
          and the position for you.
        </p>
      </ProductFeature>
      ...
      <ProductFeature id="vouched" heading="Verified before your agent ever sees it">
        <p>
          ...
          does &mdash; a forged event never surfaces to the agent, though the cursor still advances
          past it so it can&rsquo;t wedge the stream. Your agent acts on events you&rsquo;ve
          authenticated, not on raw untrusted input.
        </p>
      </ProductFeature>
      ...
      <ProductFeature id="one-contract" heading="One capability contract, four surfaces">
        <p>
          ...
          the MCP surface, so an agent can be driven by your webhooks without being able to reroute
          them.
        </p>
      </ProductFeature>
    </ProductShell>
