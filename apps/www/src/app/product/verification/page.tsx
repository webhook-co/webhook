...
export const metadata = pageMetadata({
  ...
  title: "Verification",
  // "checked", not "verified" — ~14 of the 144 only offer a shared token and land on the weaker
...
export default function VerificationPage() {
  return (
    <ProductShell
      ...
      lede="144 providers, checked at the edge. Every event lands in one of four states — and when a signature doesn't match, we name the likely reason, one of eleven codes, with the fix, instead of a bare match/no-match."
      path="/product/verification"
      name="Verification"
      visual={<VerifyCard />}
    ...
    >
      <ProductFeatures>
        <ProductFeature id="four-states" heading="Verified is not a boolean">
          <p>
            ...
            Roughly 14 of the 144 providers only offer a shared token rather than a real signature,
      ...
      {/* The claim used to be a CARD that said "144 providers in one open registry". Showing the 144
