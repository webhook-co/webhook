 ...
 * rule (the machined "eyebrow" detail); pass `rule={false}` for a centered head (e.g. the trust
 * band) where the rule would float oddly. It's a `<span>`, not a heading — the real `<h2>` follows it.
 */
