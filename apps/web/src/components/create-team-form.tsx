...
/**
 * Create an organization from a display name.
 *
 ...
 * anything else would be a lie the moment two organizations share a name.
 *
            ...
            hint={
              previewBase
                ? // The stem only — the server appends a short unique suffix, and it's all renameable later.
                  `Your organization's URL will be webhook.co/org/${previewBase}-… — you can change it later.`
