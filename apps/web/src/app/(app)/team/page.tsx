...
export default async function TeamPage() {
  ...
  // The roles this caller may hand out — the same ceiling the server action enforces. The client only ever
  // sees roles it's allowed to pick; the action re-checks regardless (the picker is UX, not the gate).
