...
<Warning>
  Square signs the notification URL. The subscription URL in Square must be your endpoint's ingest URL exactly — a trailing slash or an added query string changes the signed string and fails verification.
</Warning>
