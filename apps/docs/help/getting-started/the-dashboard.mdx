...
<CardGroup cols={2}>
  ...
  <Card title="Team" icon="users">
    The people in your organization and their [roles](/concepts/security). Invite members and manage
    access.
  </Card>
</CardGroup>
...
<Note>
  ...
  billing or the team. See [roles and what each can do](/concepts/security).
</Note>
