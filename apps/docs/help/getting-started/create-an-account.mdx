...
<Steps>
  ...
  <Step title="You're in">
    Your organization and a starter endpoint are created for you automatically, and you land in the
    dashboard. From here, the [Quickstart](/quickstart) sends your first test webhook.
  </Step>
</Steps>
