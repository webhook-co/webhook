...
description: "How MCP clients authenticate to webhook.co — a whk_ bearer token or the interactive OAuth flow — plus the consent screen, verified apps, and connected apps."
icon: "shield-check"
---
