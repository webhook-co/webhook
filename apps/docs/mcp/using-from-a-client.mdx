...
description: "Connect any MCP client to webhook.co's remote server at https://mcp.webhook.co/mcp — OAuth or a whk_ bearer token. Per-client configs for coding agents."
icon: "plug"
---
