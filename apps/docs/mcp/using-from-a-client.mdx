...
description: "Connect any MCP client to webhook.co's remote server at https://mcp.webhook.co/mcp — paste a whk_ bearer token or use the interactive OAuth sign-in. Per-client configs for coding agents."
icon: "plug"
---
