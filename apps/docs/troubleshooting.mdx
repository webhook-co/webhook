...
description: "A compact developer reference for the common webhook.co snags — signature verification, delivery failures, and the questions that come up most — with the fix for each."
...
Every error response carries a `requestId` in the `x-request-id` header — include it when you reach out, and see [errors and status codes](/reference/errors) for the full taxonomy. For account, billing, and step-by-step help, the [help center](/help/troubleshooting/overview) goes deeper, and [get more help](/help/getting-help/overview) has the ways to reach us.
