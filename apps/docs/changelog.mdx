...
<Update label="July 10, 2026" description="Agents & account controls" tags={["MCP", "API", "Dashboard", "Security"]}>
...
<Update label="July 7, 2026" description="Deduplication & dashboard" tags={["Dashboard", "API", "CLI"]}>
...
<Update label="July 4, 2026" description="Docs, OpenAPI & SDKs" tags={["Docs", "SDK", "API"]}>
...
<Update label="July 1, 2026" description="Outbound delivery" tags={["API", "CLI", "MCP"]}>
## outbound delivery
...
<Update label="June 30, 2026" description="Signature verification" tags={["Providers", "Security", "API"]}>
...
<Update label="June 29, 2026" description="Accounts & dashboard" tags={["Dashboard", "API", "Security"]}>
...
<Update label="June 24, 2026" description="CLI & distribution" tags={["CLI"]}>
## the wbhk CLI
...
<Update label="June 14, 2026" description="Launch" tags={["API"]}>
